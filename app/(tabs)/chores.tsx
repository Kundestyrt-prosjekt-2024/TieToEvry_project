...
import { View, Text, StyleSheet, Pressable, Image, Modal, Dimensions, FlatList } from "react-native"
        ...
        <View className=" flex-row justify-center items-center py-2 space-x-6">
          ...
          <View className="flex flex-col h-36 justify-between items-center ">
            ...
            <View className="flex-row items-center">
              <Image className="w-9 h-9 rounded-md" source={require("@/assets/images/coin.png")} resizeMode="contain" />
