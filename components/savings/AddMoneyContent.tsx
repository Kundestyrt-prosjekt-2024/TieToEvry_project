...
interface AddMoneyContentProps {
  ...
  <View className="flex-col items-center">
    ...
    <View>
      ...
      <Text className="text-3xl text-center">GOAL TITLE</Text>
    </View>
    <View style={{ width: 50, height: 50 }} className="mt-2 border-2 rounded-full items-center justify-center">
            ...
            <View className="mt-3">
              {/** TODO: Make dynamic */}
              <Text className="text-l text-center">Du mangler: GOAL - DEPOSITED</Text>
              <Text className="text-l text-center mt-1">Du har: BALANCE</Text>
            </View>
            ...
            {/** TODO: should route to function that deposits money and changes balance */}
